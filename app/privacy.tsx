    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
                <Text style={[styles.heading, { color: colors.text }]}>CampusBarter Privacy Policy</Text>
                ...
                <Text style={[styles.body, { color: colors.textSecondary }]}>
                    ...
                    <Text style={[styles.subhead, { color: colors.text }]}>Information We Collect{'\n'}</Text>
                    ...
                    <Text style={[styles.subhead, { color: colors.text }]}>How We Use Your Data{'\n'}</Text>
                    ...
                    <Text style={[styles.subhead, { color: colors.text }]}>Data Sharing{'\n'}</Text>
                    ...
                    <Text style={[styles.subhead, { color: colors.text }]}>Your Rights{'\n'}</Text>
                    ...
                    <Text style={[styles.subhead, { color: colors.text }]}>Data Retention{'\n'}</Text>
                    ...
                    <Text style={[styles.subhead, { color: colors.text }]}>Security{'\n'}</Text>
