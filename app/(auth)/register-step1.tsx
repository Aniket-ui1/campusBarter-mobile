        ...
        <KeyboardAvoidingView style={[styles.container, { backgroundColor: colors.background }]} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
            <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
                ...
                <Animated.View entering={FadeInDown.duration(500)}>
                    ...
                    <Text style={[styles.subtitle, { color: colors.textSecondary }]}>Start with your email and a secure password.</Text>
                </Animated.View>
                ...
                <View style={styles.bottomRow}>
                    <Text style={[styles.bottomText, { color: colors.textSecondary }]}>Already have an account? </Text>
                    <Pressable onPress={() => router.replace('/(auth)/sign-in')}>
                        <Text style={[styles.bottomLink, { color: colors.primary }]}>Sign In</Text>
                    </Pressable>
                </View>
            </ScrollView>
