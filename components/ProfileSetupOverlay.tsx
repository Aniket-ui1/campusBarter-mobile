...
const styles = StyleSheet.create({
    ...
    headerIcon: {
        ...
        backgroundColor: AppColors.surfaceLight ?? AppColors.surface,
    ...
    sectionDesc: { fontSize: 13, color: AppColors.textSecondary, marginBottom: 4 },
    ...
    divider: { height: 1, backgroundColor: AppColors.border, marginVertical: Spacing.sm },
